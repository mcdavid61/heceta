/*-----------------------------------------------------------------------------
   ...
   except by express wirtten agreement with Bacharach Inc.

   First Written on 12/30/13 by Chris Prozzo

   Module Description: CRC algorithm for modbus
...
/*------------------------------------------------------------------------------
   FUNCTION NAME: CRC16
   returns       : 16 bit CRC of supplied data
   arg1          : pointer to data
   arg2          : number of bytes in data set
   Created by    : Chris Prozzo
   Date created  : 1/5/13
   Description   : Computes 16bit CRC of an array if bytes
   Notes         :
   -------------------------------------------------------------------------------*/
